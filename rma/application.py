...
def connect_to_redis(host, port, db=0, username="", password=None, ssl=False):
    """
...
class RmaApplication(object):
    ...
    def __init__(self, host="127.0.0.1", port=6367, username="", password=None, db=0, ssl=False, match="*",
                 limit=0, filters=None, logger=None, format="text", separator=":"):
